...
# --------------------------
# combien de handle 
puts "Dans cette liste il y a #{journalist.length} handles" 
...
compteur_maj = 0
journalist.each do |word|
	if word[1] == word[1].upcase 
		compteur_maj += 1
	end
end 
	puts "Il y a #{compteur_maj} handles commençant par une majuscule"
puts 
# --------------------------
...
# --------------------------
#Index de @epenser
puts "La position de @epenser dans l'array est #{journalist.index ("@epenser")} ème."
